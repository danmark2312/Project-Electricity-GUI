...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.drop_input.setTextInteractionFlags(QtCore.Qt.NoTextInteraction)
        ...
        self.horizontalLayout_6 = QtWidgets.QHBoxLayout(self.cmd_box)
        self.horizontalLayout_6.setObjectName("horizontalLayout_6")
        self.stat_btn = QtWidgets.QPushButton(self.cmd_box)
        self.stat_btn.setObjectName("stat_btn")
        self.horizontalLayout_6.addWidget(self.stat_btn)
        self.plot_btn = QtWidgets.QPushButton(self.cmd_box)
        self.plot_btn.setObjectName("plot_btn")
        self.horizontalLayout_6.addWidget(self.plot_btn)
